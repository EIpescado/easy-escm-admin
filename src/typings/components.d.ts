...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    TableRowOperation: typeof import('./../components/advanced/table-row-operation.vue')['default']
...
declare global {
  ...
  const TableRowOperation: typeof import('./../components/advanced/table-row-operation.vue')['default']
